...
<html>
    ...
    <body>
      ...
      <?php
                      			$servname = "localhost"; $dbname = "bd_megane_biblio"; $dbuser = "root"; $dbpass = "";
      ...
      <h1>Formulaire HTML</h1>
        ...
        <form action="createlivre.php" method="post" enctype="multipart/form-data">
            ...
            <div class="c100">
                ...
                <input type="file" id="logo_livre" name="logo_livre">
            </div>
            <div class="c100">
            ...
            <div class="c100">
                <label for="id_bibliotheque"> Bibliothèque : </label>
                    ...
                    <a href="../bibliobackend/formcreatebiblio.php"> Ajouter Bibliothèque </a>
            </div>
