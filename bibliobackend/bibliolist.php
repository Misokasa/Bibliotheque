...
les information dans la base puis redirige vers BiblioList.php) -->
    ...
    <body>
        ...
        <h1> Cours PHP / MySQL </h1>
            ...
            <a class='btn btn-info btn-xs' href='starter.php?page=formbiblio'><span class='glyphicon glyphicon-edit'></span> Nouvelle Bibliothèque </a>
                  ...
                  $anyname = $dbco->prepare("SELECT id_bibliotheque,nom,adresse,telephone FROM bibliotheque");
                        ...
                        *avec le nom des colonnes sélectionnées en clefs*/
                        ...
                        foreach ($resultat as $row => $bibliotheque) {
                            ...
                            echo "<td> <a class='btn btn-info btn-xs' href='starter.php?page=formbiblio&id_bibliotheque=".$bibliotheque['id_bibliotheque']."'><span class='glyphicon glyphicon-edit'></span> Edit </a>";

                            echo "<td> <a class='btn btn-danger btn-xs' href='".$chemin["deletebiblio"]."?id_bibliotheque=".$bibliotheque['id_bibliotheque']."'><span class='glyphicon glyphicon-remove'></span> Delete </a>";
